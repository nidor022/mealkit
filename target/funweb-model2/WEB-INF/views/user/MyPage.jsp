...
<div align="center">
	<table border="1" class="type11">
		...
		<th scope="cols"><%=name %> 님 환영합니다.</th>
			...
			<tr>
			<td align="center" height="100px"><button onclick="location='UserUpdate.do'">회원수정</button></td>
			</tr>

			<tr>
			<td align="center" height="100px"><button onclick="UserDelete()">회원탈퇴</button></td>
			</tr>

			<tr>
			<td align="center" height="100px"><button onclick="location='orderPage.do'">주문목록</button></td>
			</tr>
