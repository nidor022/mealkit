...
%><script>alert("장바구니에 담았습니다."); location.href = "shopMain.do"</script> <% 


// 로그인을 했으면
} else {
	%>
	<script>alert("회원님 장바구니에 담았습니다."); 
			location.href = "UserCartProcess.do?id=<%=id %>+&name=<%=name %>+&price=<%=price %>+&pagename=<%=pagename%>"</script> 
	<%
