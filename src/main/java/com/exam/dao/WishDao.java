...
public class WishDao {
	...
	public void addWish(String id, String name, int price) {
		Connection con = null;
		...
		try {
			...
			String sql ="";
			sql += "INSERT INTO wish(user_id, product_name, product_price, product_count) ";
			sql += "VALUES (?, ?, ?, ?) ";
	...
	public boolean itemCheck(String userId, String name) {
        ...
        try {
            ...
            String sql ="";
            sql += "SELECT count(*) FROM wish WHERE user_id = ? AND product_name = ? ";
	...
	public boolean wishCheck(String userId) {
        ...
        try {
            ...
            String sql ="";
            sql += "SELECT count(*) FROM wish WHERE user_id = ? ";
	...
	public void countPlus(String id, String name) {
		...
		try {
			...
			String sql ="";
			sql += "UPDATE wish SET product_count = product_count + 1 WHERE user_id = ? AND product_name = ? ";
	...
	public ArrayList<CartDTO> getItemsById(String id){
		...
		try {
			...
			sql += "SELECT user_id, product_name, product_price, product_count FROM wish WHERE user_id = ? ";
	...
	public void del(String id) {
		...
		try {
			...
			sql = "DELETE FROM wish WHERE user_id = ? ";
